...
const GeoLayout luigi_002_switch_opt0_001_switch_opt1_jump_mario_armature_002_switch_option_002[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_SWITCH_CASE(0, geo_switch_mario_eyes),
		GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt1_jump_mario_right_hand_open_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt1_jump_mario_left_hand_open_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt1_jump_mario_left_hand_peace_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt1_jump_mario_left_hand_cap_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt1_jump_mario_left_hand_wing_cap_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(5, 68, 0, 0, luigi_000_offset_001_mesh),
					GEO_OPEN_NODE(),
						...
						GEO_OPEN_NODE(),
							...
							GEO_OPEN_NODE(),
								...
								GEO_OPEN_NODE(),
									...
									GEO_OPEN_NODE(),
										...
										GEO_CLOSE_NODE(),
									GEO_CLOSE_NODE(),
									GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt1_jump_mario_armature_002_switch_option_002),
								GEO_CLOSE_NODE(),
								GEO_TRANSLATE_ROTATE(0, 259, -51, -126, 15, -33, -133),
								GEO_OPEN_NODE(),
							...
							GEO_CLOSE_NODE(),
						GEO_CLOSE_NODE(),
						GEO_ANIMATED_PART(1, 105, 11, 79, NULL),
						GEO_OPEN_NODE(),
								...
								GEO_OPEN_NODE(),
									...
									GEO_OPEN_NODE(),
										...
										GEO_OPEN_NODE(),
											...
											GEO_CLOSE_NODE(),
										GEO_CLOSE_NODE(),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt1_jump_mario_right_hand_open_armature),
									GEO_CLOSE_NODE(),
								GEO_CLOSE_NODE(),
							GEO_CLOSE_NODE(),
						GEO_CLOSE_NODE(),
						GEO_ANIMATED_PART(1, 106, 11, -79, NULL),
						GEO_OPEN_NODE(),
								...
								GEO_OPEN_NODE(),
									...
									GEO_OPEN_NODE(),
										...
										GEO_OPEN_NODE(),
											...
											GEO_CLOSE_NODE(),
										GEO_CLOSE_NODE(),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt1_jump_mario_left_hand_open_armature),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt1_jump_mario_left_hand_peace_armature),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt1_jump_mario_left_hand_cap_armature),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt1_jump_mario_left_hand_wing_cap_armature),
									GEO_CLOSE_NODE(),
								GEO_CLOSE_NODE(),
							GEO_CLOSE_NODE(),
						GEO_CLOSE_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_ANIMATED_PART(1, 13, -9, -42, NULL),
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(5, 0, 0, 0, luigi_000_offset_012_mesh),
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(5, 89, 1, 0, luigi_000_offset_013_mesh),
						GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt2_jump_mario_armature_002_switch_option_002[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_SWITCH_CASE(0, geo_switch_mario_eyes),
		GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt2_jump_mario_right_hand_open_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt2_jump_mario_left_hand_open_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt2_jump_mario_left_hand_peace_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt2_jump_mario_left_hand_cap_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt2_jump_mario_left_hand_wing_cap_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_ROTATION_NODE(0, 0, 0, 0),
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(1, 68, 0, 0, luigi_000_offset_001_mesh_mat_override_metal_0),
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(1, 87, 0, 0, NULL),
						GEO_OPEN_NODE(),
							GEO_ASM(0, geo_mario_head_rotation),
							...
							GEO_OPEN_NODE(),
								...
								GEO_OPEN_NODE(),
									...
									GEO_OPEN_NODE(),
										...
										GEO_CLOSE_NODE(),
									GEO_CLOSE_NODE(),
									GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt2_jump_mario_armature_002_switch_option_002),
								GEO_CLOSE_NODE(),
								GEO_TRANSLATE_ROTATE(0, 259, -51, -126, 15, -33, -133),
								GEO_OPEN_NODE(),
									GEO_ASM(0, geo_mario_rotate_wing_cap_wings),
								...
								GEO_OPEN_NODE(),
									...
									GEO_OPEN_NODE(),
										...
										GEO_OPEN_NODE(),
											...
											GEO_CLOSE_NODE(),
										GEO_CLOSE_NODE(),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt2_jump_mario_right_hand_open_armature),
									GEO_CLOSE_NODE(),
								GEO_CLOSE_NODE(),
							GEO_CLOSE_NODE(),
						GEO_CLOSE_NODE(),
								...
								GEO_OPEN_NODE(),
									...
									GEO_OPEN_NODE(),
										...
										GEO_OPEN_NODE(),
											...
											GEO_CLOSE_NODE(),
										GEO_CLOSE_NODE(),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt2_jump_mario_left_hand_open_armature),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt2_jump_mario_left_hand_peace_armature),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt2_jump_mario_left_hand_cap_armature),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt2_jump_mario_left_hand_wing_cap_armature),
									GEO_CLOSE_NODE(),
								GEO_CLOSE_NODE(),
							GEO_CLOSE_NODE(),
						GEO_CLOSE_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(1, 89, 1, 0, luigi_000_offset_013_mesh_mat_override_metal_0),
						GEO_OPEN_NODE(),
							GEO_ANIMATED_PART(1, 67, 0, 0, NULL),
							GEO_OPEN_NODE(),
								GEO_ASM(2, geo_mario_hand_foot_scaler),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt3_jump_mario_armature_002_switch_option_002[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_SWITCH_CASE(0, geo_switch_mario_eyes),
		GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt3_jump_mario_right_hand_open_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt3_jump_mario_left_hand_open_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt3_jump_mario_left_hand_peace_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt3_jump_mario_left_hand_cap_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
...
const GeoLayout luigi_002_switch_opt0_001_switch_opt3_jump_mario_left_hand_wing_cap_armature[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_ROTATION_NODE(0, 0, 0, 0),
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(5, 68, 0, 0, luigi_000_offset_001_mesh_mat_override_metal_0),
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(1, 87, 0, 0, NULL),
						GEO_OPEN_NODE(),
							GEO_ASM(0, geo_mario_head_rotation),
							...
							GEO_OPEN_NODE(),
								...
								GEO_OPEN_NODE(),
									...
									GEO_OPEN_NODE(),
										...
										GEO_CLOSE_NODE(),
									GEO_CLOSE_NODE(),
									GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt3_jump_mario_armature_002_switch_option_002),
								GEO_CLOSE_NODE(),
								GEO_TRANSLATE_ROTATE(0, 259, -51, -126, 15, -33, -133),
								GEO_OPEN_NODE(),
									GEO_ASM(0, geo_mario_rotate_wing_cap_wings),
								...
								GEO_OPEN_NODE(),
									...
									GEO_OPEN_NODE(),
										...
										GEO_OPEN_NODE(),
											...
											GEO_CLOSE_NODE(),
										GEO_CLOSE_NODE(),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt3_jump_mario_right_hand_open_armature),
									GEO_CLOSE_NODE(),
								GEO_CLOSE_NODE(),
							GEO_CLOSE_NODE(),
						GEO_CLOSE_NODE(),
								...
								GEO_OPEN_NODE(),
									...
									GEO_OPEN_NODE(),
										...
										GEO_OPEN_NODE(),
											...
											GEO_CLOSE_NODE(),
										GEO_CLOSE_NODE(),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt3_jump_mario_left_hand_open_armature),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt3_jump_mario_left_hand_peace_armature),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt3_jump_mario_left_hand_cap_armature),
										GEO_BRANCH(1, luigi_002_switch_opt0_001_switch_opt3_jump_mario_left_hand_wing_cap_armature),
									GEO_CLOSE_NODE(),
								GEO_CLOSE_NODE(),
							GEO_CLOSE_NODE(),
						GEO_CLOSE_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						GEO_ANIMATED_PART(5, 89, 1, 0, luigi_000_offset_013_mesh_mat_override_metal_0),
						GEO_OPEN_NODE(),
							GEO_ANIMATED_PART(1, 67, 0, 0, NULL),
							GEO_OPEN_NODE(),
								GEO_ASM(2, geo_mario_hand_foot_scaler),
							...
							GEO_OPEN_NODE(),
								...
								GEO_OPEN_NODE(),
									...
									GEO_OPEN_NODE(),
										...
										GEO_ROTATION_NODE(0, 0, 0, 0),
										GEO_OPEN_NODE(),
											GEO_ANIMATED_PART(1, 68, 0, 0, luigi_000_offset_001_mesh),
											GEO_OPEN_NODE(),
												GEO_ANIMATED_PART(1, 87, 0, 0, NULL),
												GEO_OPEN_NODE(),
													GEO_ASM(0, geo_mario_head_rotation),
										...
										GEO_OPEN_NODE(),
											...
											GEO_OPEN_NODE(),
												GEO_ANIMATED_PART(1, 89, 1, 0, luigi_000_offset_013_mesh),
												GEO_OPEN_NODE(),
													GEO_ANIMATED_PART(1, 67, 0, 0, NULL),
													GEO_OPEN_NODE(),
														GEO_ASM(2, geo_mario_hand_foot_scaler),
