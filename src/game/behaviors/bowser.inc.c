...
void falling_bowser_plat_act_2(void) {
    ...
    if (o->oTimer < 22) {
        set_environmental_camera_shake(SHAKE_ENV_FALLING_BITS_PLAT, gMarioStates[0].thisPlayerCamera);
        set_environmental_camera_shake(SHAKE_ENV_FALLING_BITS_PLAT, gMarioStates[1].thisPlayerCamera);
        o->oVelY = 8.0f;
        o->oGravity = 0.0f;
    } else
        o->oGravity = -4.0f;
