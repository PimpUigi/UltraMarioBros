...
void spawn_child_obj_relative(struct Object *parent, s16 xOffset, s16 yOffset, s16 zOffset, s16 pitchOffset,
    ...
    sp1C->oEndBirdUnk104 = sCutsceneVars[9][0].point[0];
    sCutsceneVars[9][0].point[0] += 1.f;
    sp1C->oPosX += xOffset;
    sp1C->oPosY += yOffset;
...
void bhv_intro_scene_loop(void) {
    ...
    if (gCutsceneObjSpawn[0] != 0) {
        ...
        gCutsceneObjSpawn[0] = 0;
        gCutsceneObjSpawn[1] = 0;
    }
}
