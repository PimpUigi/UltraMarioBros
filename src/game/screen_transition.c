...
Gfx *render_cannon_circle_base(void) {
    ...
    if (verts != NULL && dlist != NULL) {
        ...
        make_vertex(verts, 1, SCREEN_WIDTH, 0, -1, 1252, 1824, 0, 0, 0, 255);
        make_vertex(verts, 2, SCREEN_WIDTH, SCREEN_HEIGHT, -1, 1252, 192, 0, 0, 0, 255);
        make_vertex(verts, 3, 0, SCREEN_HEIGHT, -1, -1252, 192, 0, 0, 0, 255);
